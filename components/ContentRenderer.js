...
class ContentRenderer {
  ...
  render(data, options = {}) {
    ...
    if (this.steemRenderer) {
      ...
      // Fallback: use marked+DOMPurify (loaded in index.html) when SteemContentRenderer is unavailable
      if (typeof marked !== 'undefined') {
        ...
        container.innerHTML = this.basicMarkdownToHtml(body);
      }
    }
  ...
  /**
   * Basic markdown to HTML conversion (fallback when SteemContentRenderer is unavailable)
   */
